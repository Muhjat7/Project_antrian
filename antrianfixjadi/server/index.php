    ...
    <div class="container">
        <center>
            <div class="blog-header">
                <img src="../assert/img/upb.png" width="100px;" style="margin: 8px;">
                <marquee behavior="alternate">
                    <h3 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;"><b>Selamat datang di Loket
                            Kami</b></h3>
                </marquee>
            </div>
        </center>
        ...
        <footer class="footer">
            <center>
                <p>&copy; UPB Kelompok 3 <?php echo date("Y");?></p>
            </center>
        </footer>
    </div>
</body>
        ...
        $.post("../apps/monitoring-daemon.php", function(data) {
            ...
            if (tmp_loket == 0) {
                for (var i = 1; i <= data['jumlah_loket']; i++) {
                    loket = '<div class="col-md-3">' +
                        ...
                        '<button class="btn btn-danger" type="button"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET ' +
                        i + '</button>' +
                        '</div>' +
                        '</div>';
                    $(".loket").append(loket);
            ...
            if (data["next"]) {
                ...
                for (var i = 0; i < angka.toString().length; i++) {
                    $(".audio").append('<audio id="suarabel' + i + '" src="../audio/new/' +
                        angka.toString().substr(i, 1) + '.MP3" ></audio>');
                };
